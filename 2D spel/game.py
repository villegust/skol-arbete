...
music = pygame.mixer.music.load("music4.mp3")
...
class enemy(object):
    ...
    def __init__(self, x, y, witdh, height, end):
        self.x = []
        self.y = []
        self.width = []
        self.height = []
        self.x = random.randint(10, 410)
        self.y = y
        self.width = witdh
        self.height = height
        self.end = end
    ...
    class platform(object):
       platform = [pygame.image.load('platform2.jpg')]
        


def redrawGameWindow():
    win.blit(bg, (0,0))
    text = font.render('Life: ' + str(life), 1, (255,255,255))
    text2 = font.render('Score:' + str(score),1, (255,255,255))
    win.blit(text, (465, 20))
    win.blit(text2, (290, 20))
    man.draw(win)
    goblin.draw(win)
    goblin1.draw(win)
...
man = player(0, 412, 64,64)
goblin = enemy(100, 417, 64, 64, 460)
goblin1 = enemy(120, 417, 64, 64, 460)
platform = (450,240)
shootLoop = 0    
bullets = []
run = True
    ...
    if ((goblin.visible == True) and (man.visible == True)):
        if man.hitbox[1] < goblin.hitbox[1] + goblin.hitbox[3] and man.hitbox[1] + man.hitbox[3] > goblin.hitbox[1]:
            ...
            if life == 0:
                ...
                music = pygame.mixer.music.load("music6.mp3")
                pygame.mixer.music.play(1)                    
